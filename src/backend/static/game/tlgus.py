...
class Dino:
    ...
    def draw(self, screen, inverted=False):
        ...
        neck_rect1.center = (head_rect.left + neck_connect_width // 2 - 2,
                             head_rect.bottom - neck_connect_height // 4 + head_offset_y)
        pygame.draw.ellipse(screen, body_color, neck_rect1)

        neck_rect2 = pygame.Rect(0, 0, neck_connect_width // 2, neck_connect_height // 2)
        neck_rect2.center = (head_rect.left + neck_connect_width // 2 + 5,
                             head_rect.bottom - neck_connect_height // 8 + head_offset_y)
        ...
        right_shoe = pygame.Rect(self.rect.x + self.rect.width - shoe_width - 5,
                                 self.rect.y + self.rect.height - shoe_height, shoe_width, shoe_height)
...
def game_over_screen(screen, font, score, background_surface=None, inverted=False, pressed_button=None):
